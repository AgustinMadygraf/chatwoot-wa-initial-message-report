...
from use_cases.ports.repositories import MessagesRepositoryPort
from entities.chatwoot import Message
    ...
    for convo_id in conversation_ids:
        ...
        while True:
            ...
            for message in items:
                ...
                if model.message_type is not None and model.message_type not in (0, 1):
                    logger.debug(
